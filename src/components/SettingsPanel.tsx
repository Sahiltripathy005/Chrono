          ...
          <div className="flex flex-col gap-2">
            ...
            {settings.launch_at_startup && (
              <button
                ...
                className={`w-full py-1.5 rounded transition-all text-[9.5px] font-extrabold tracking-wider border transition-all duration-200 uppercase interactive-control focus:outline-none ${
